 ...
 */
export type LibrarySoundName = `ambient/${AmbientSoundName}` | `arcade/${ArcadeSoundName}` | `game/${GameSoundName}` | `misc/${MiscSoundName}` | `notification/${NotificationSoundName}` | `system/${SystemSoundName}` | `ui/${UiSoundName}`;
/**
